...
### Changed
- Foundry VTT v14 compatibility verified. Bumped `compatibility.verified` to `14`. No source changes were required — the existing ApplicationV2, DialogV2, and `getSceneControlButtons` patterns are unchanged in v14.
